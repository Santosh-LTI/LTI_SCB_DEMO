...
public class TransmitterController {
	...
	@RequestMapping(value = ReceiverConstants.ADD_TRANSMITTER_URL, method = RequestMethod.POST, produces = {
	...
	@RequestMapping(value = "/transmit/{transactionType}", method = RequestMethod.POST, produces = {
			"application/xml", "application/json" })
	public String transmit(@RequestHeader Map<String, String> requestMap,@PathVariable("transactionType") String transmittertype) {
		log.info("RequestHeader received " + requestMap);
		String transmitResp = transmitterService.getTransmitByType(requestMap, transmittertype);
		return transmitResp;
	}
}